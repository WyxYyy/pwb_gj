<template>
    <div>
        <navBar title="业务员业绩"></navBar>
        <div class="teamStatistics ">
            <header>
                <div class=" headerScreen flex">
                    <div class=" Salesman">
                        <img src="../../assets/img/my_head.png" alt="">
                        <div class="flexColumn">
                            <span>{{Statistics.userNickname}}</span>
                            <span>
                                {{Statistics.mobile}}
                            </span>
                        </div>
                    </div>
                    <pwbIcon class="icon-Salesman" @click.native="callPhone(Statistics.mobile)"></pwbIcon>
                </div>
            </header>
            <div class="myData">
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.get(this.Interface.config.peopleStatistics,{id:userId},'Statistics')
            this.get(this.Interface.config.peopleHouseList,{id:userId},'allList')
            this.get(this.Interface.config.peopleHouseList,{type:'year',id:userId},'yrarList')
            this.get(this.Interface.config.peopleHouseList,{type:'month',id:userId},'monthList')
        }
    }
</script>
